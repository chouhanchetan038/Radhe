...
const AadharOtpVerification = ({
  ...
  const handleOtpSubmit = () => {
    if (form?.otp && form.otp.length === 6) {
      ...
      setFormError({ otp: 'Please enter otp' });
    }
  };
      ...
      <DialogContent dividers={true}>
        ...
        <div className="max-w-sm mt-4 mx-auto mb-8">
          ...
          <p className="text-12 lg:text-16 text-black text-center mb-8">
            We have sent you a 6 digit OTP on your registered Mobile Number
          </p>
        </div>
        <div>
          <OtpInput
            ...
            inputStyle={{
              ...
              borderRadius: '6px',
              outline: 'none',
              border: `1px solid ${formError.otp ? '#C31515' : 'black'} `,
              background: 'transparent',
              boxShadow: formError.otp
        ...
        <div className="flex justify-end">
          <p className=" text-12  mt-5">
            <span className="text-black"> Didn&lsquo;t receive the code? </span>
            {timer > 0 ? (
...
AadharOtpVerification.propTypes = {
